...
class PrivateKeyValidation extends BaseWallet {
  final HDWallet wallet;

  const PrivateKeyValidation(this.wallet,{Key? key}) : super('PrivateKeyIsValid',key: key);

  @override
  _PrivateKeyValidationState createState() => _PrivateKeyValidationState();
}

class _PrivateKeyValidationState extends BaseWalletState<PrivateKeyValidation> {
  @override
  void initState() {
