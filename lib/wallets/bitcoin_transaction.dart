...
class BitcoinTransaction extends BaseWallet {
  final HDWallet wallet;

  const BitcoinTransaction(this.wallet,{Key? key}) : super('Bitcoin Transaction',key: key);

  @override
  _BitcoinTransactionState createState() => _BitcoinTransactionState();
}

class _BitcoinTransactionState extends BaseWalletState<BitcoinTransaction> {
  @override
  void initState() {
